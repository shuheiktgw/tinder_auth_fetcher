...
TinderAuthFetcher is inspired by @andrewpeterprifer 's [tinder-token-retriever](https://github.com/andrewpeterprifer/tinder-token-retriever) written in Python. Thank you Andrew! :smile:
